...
- **Content:**
  - **분할:** [D-021]/[D-022] 반영 후 자체수집 540세션은 **3-fold cross-subject**로 평가한다. subject는 피험자를 뜻하며, `S01`/`S02`/`S03`는 피험자 코드다. E4는 test 전용 환경으로 봉인하지 않고 subject 기준으로 train/test에 함께 분배한다.
